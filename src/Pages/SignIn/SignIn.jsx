             ...
             <h1 className='text-black text-xl font-semibold uppercase pb-8'>Customer Login</h1>
                <div className='grid lg:grid-cols-2 grid-cols-1 gap-5'>
                   ...
                   <h3 className='pb-2 text-balance font-semibold'>Email   <span className='text-red-500'> *</span></h3>
                     ...
                     <input type={passwordType} name='password' className='w-full p-2 bg-white border border-gray-800 outline-none' required/>
                     </div>
                     <div className='flex items-center text-black gap-3'>
                        <input type="checkbox" className='w-5 h-5 hover:cursor-pointer' onChange={handlePasswordType}/><p className='text-black '>Show Password</p>
                     </div>
                  <div className='mt-8'>
